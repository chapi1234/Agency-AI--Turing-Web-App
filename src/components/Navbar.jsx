  ...
  return (
    ...
    backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
            ...
            <img src={assets.close_icon} alt="cross icon" className='w-5 absolute right-4 top-4 sm:hidden' onClick={() => setSidebarOpen(false)} />
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
            ...
            <img src={theme === 'dark' ? assets.mode_icon_dark : assets.menu_icon} alt="" onClick={() => setSidebarOpen(true)}
